...
window.snapKitInit = function () {
  ...
  snap.loginkit.mountButton(loginButtonIconId, {
    clientId: '25e97c6d-9ffd-4bee-92bc-e095a63b5809', /*YOU CHANGE: Must be changed to the development client ID on snapckit*/
    redirectURI: 'https://happy-to-snake-the-way.glitch.me/', /*YOU CHANGE: Must be changed to your glitch project's url AND added as the redirect URI on snapkit */
    scopeList: [
      'user.display_name',
      'user.bitmoji.avatar',
    ],
